...
import 'package:gsolution/common/api_factory/models/base_list.dart';
...
import 'package:gsolution/common/config/app_images.dart';
import 'package:gsolution/common/config/config.dart';
import 'package:gsolution/common/config/localization/localize.dart';
...
Future<void> handleSessionExpired() async {
  ...
  navigatorKey.currentState?.pushNamedAndRemoveUntil(
    AppRoutes.signIn, // Change to your initial login route
