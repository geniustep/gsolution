...
// class AccountCaisseMoveLinePayableView extends StatefulWidget {
//   const AccountCaisseMoveLinePayableView({Key? key}) : super(key: key);

//   @override
//   State<AccountCaisseMoveLinePayableView> createState() =>
//       _AccountCaisseMoveLinePayableViewState();
// }

// class _AccountCaisseMoveLinePayableViewState
//     extends State<AccountCaisseMoveLinePayableView> {
//   List<AccountMoveLineModel> accountMoveLine = [];
//   var tMoveLine = <AccountMoveLineModel>[].obs;
...
//             builder: () => const AccountCaisseMoveLineReceivableView());
//         break;
//       case 1:
//         break;
//     }
...
//         setState(() {
//           tMoveLine.clear();
//           tMoveLine.addAll(response[response.keys.toList()[0]]!);
//           accountMoveLine = tMoveLine.where((p0) => p0.credit != 0).toList();
//           totalCredit = 0;
//           totalCredit =
